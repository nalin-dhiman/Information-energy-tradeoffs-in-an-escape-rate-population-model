...
def fig1_model_objective():
    ...
    plt.savefig(FIG_DIR / "model_objective.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 1 saved.")
...
def fig2_estimator_validation():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / "estimator_validation.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 2 saved.")
...
def fig3_pareto_frontier():
    ...
    plt.savefig(FIG_DIR / "pareto_frontier.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 3 saved.")
...
def fig4_tau_transition():
    ...
    plt.savefig(FIG_DIR / "tau_transition.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 4 saved.")
...
def fig5_sparsity_structure():
    ...
    plt.savefig(FIG_DIR / "sparsity_structure.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 5 saved.")
...
def fig6_robustness():
    ...
    plt.legend()
    plt.savefig(FIG_DIR / "stimulus_robustness.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 6 saved.")
...
def fig7_ablations():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / "ablations.pdf", bbox_inches='tight')
    plt.close()
    print("Fig 7 saved.")
